...
1. Select **Add a scope** button open the **Add a scope** screen and Enter the values as indicated below:
    ...
    1. For **Admin consent description** type in *e.g. Allows the app to get LLM response.*.
    1. For **User consent display name** type in *scopeName*.
    1. For **User consent description** type in *eg. Allows the app to get LLM response.*.
